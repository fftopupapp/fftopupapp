...
export const metadata: Metadata = {
  ...
  description: 'Free Fire Diamonds Top Up in Bangladesh instantly with bKash, Nagad & Rocket. Secure FF Diamonds Top Up, fast delivery, best prices and trusted FF TOP UP APP service.',
  keywords: ['free fire diamonds top up', 'diamonds top up bd', 'ff diamonds top up bangladesh'],
  alternates: {
    canonical: "https://fftopupapp.com",
  },
  openGraph: {
...
async function fetchSiteSettings() {
    try {
        const apiUrl = process.env.NEXT_PUBLIC_API_URL || 'https://backend.fftopupapp.com';
...
async function fetchRecentOrders() {
    try {
        const res = await fetch('https://backend.fftopupapp.com/api/recent-orders', {
            cache: 'no-store'
        });
...
export default async function HomePage({ searchParams }: { searchParams: { page?: string } }) {
    ...
    />
            ...
            <div className="container mx-auto">
                ...
                <div className="text-center mb-6 mt-10">
                    <div className="flex items-center justify-center px-4 py-4 md:py-8">
                        ...
                        <h1 className="text-2xl sm:text-3xl font-bold mx-4 text-white-900 font-primary">FF TOP UP APP</h1>
                        <hr className="flex-grow border-gray-300" />
                    </div>
                </div>
        ...
        <section className="mx-auto mt-16 mb-6 bg-white/5 border border-white/10 rounded-2xl p-8 text-gray-300 leading-8">
          ...
          <p className="mb-5">
            FF TOP UP APP is Bangladesh’s trusted platform for Free Fire Diamonds Top Up.
            Buy FF Diamonds instantly using bKash, Nagad and Rocket with secure automated delivery.
            We provide affordable FF TOP UP APP services for all Bangladeshi gamers.
          </p>
